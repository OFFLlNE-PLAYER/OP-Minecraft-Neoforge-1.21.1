...
public class PrototypeGunbladeItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.opminecraft.prototype_gunblade.description_1"));
		list.add(Component.translatable("item.opminecraft.prototype_gunblade.description_2"));
	}
}
