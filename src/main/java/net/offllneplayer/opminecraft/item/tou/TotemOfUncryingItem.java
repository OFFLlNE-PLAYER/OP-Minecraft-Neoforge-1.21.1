...
public class TotemOfUncryingItem extends Item {
	public TotemOfUncryingItem() {super(new Properties()
	...
	public void appendHoverText(ItemStack itemstack, TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.opminecraft.totem_of_uncrying.description_0"));
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if ((selected) || (slot == 40)) {TOUActivate_Method.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);}
	}
}