...
public enum PistolMaterial {
	...
	PROTEKTOR_BERETTA(16, 4.5F, 4, 22, 32, 15, OP_TagKeyUtil.Blocks.EMPTY_BLOCK_TAG, 2F, Rarity.EPIC, true,
			RegistrySounds.PROTEKTOR_BERETTA_1, RegistrySounds.PROTEKTOR_BERETTA_R, RegistrySounds.PROTEKTOR_BERETTA_0, 0.9F, 1.0420F, 0.0420F),

	PROTEKTOR_HANDCANNON(12, 5.5F, 6, 28, 40, 15, OP_TagKeyUtil.Blocks.EMPTY_BLOCK_TAG, 2F, Rarity.EPIC, true,
			RegistrySounds.PROTEKTOR_BERETTA_1, RegistrySounds.PROTEKTOR_BERETTA_R, RegistrySounds.PROTEKTOR_BERETTA_0, 1F, 0.96F, 0.0420F),
