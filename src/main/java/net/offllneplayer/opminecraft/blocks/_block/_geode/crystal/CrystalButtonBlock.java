...
public class CrystalButtonBlock extends ButtonBlock {
	public CrystalButtonBlock() {
		super(BlockSetType.STONE, 20, Properties.of().sound(SoundType.AMETHYST).strength(5.5f, 12f).lightLevel(s -> 2).requiresCorrectToolForDrops());
	}

	public CrystalButtonBlock(Properties properties) {
