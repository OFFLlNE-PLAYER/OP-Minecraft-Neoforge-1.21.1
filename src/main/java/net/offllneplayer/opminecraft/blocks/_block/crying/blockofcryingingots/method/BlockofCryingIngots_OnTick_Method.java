package net.offllneplayer.opminecraft.blocks._block.crying.blockofcryingingots.method;
...
public class BlockofCryingIngots_OnTick_Method {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((world.getBlockState(BlockPos.containing(x - 1, y, z))).is(OP_TagKeyUtil.Blocks.SOUL_FIRES)
				|| (world.getBlockState(BlockPos.containing(x + 1, y, z))).is(OP_TagKeyUtil.Blocks.SOUL_FIRES)
				|| (world.getBlockState(BlockPos.containing(x, y + 1, z))).is(OP_TagKeyUtil.Blocks.SOUL_FIRES)
				|| (world.getBlockState(BlockPos.containing(x, y - 1, z))).is(OP_TagKeyUtil.Blocks.SOUL_FIRES)
