...
public class CrystalFenceBlock extends FenceBlock {
	public CrystalFenceBlock() {
		super(Properties.of().sound(SoundType.AMETHYST).strength(5.5f, 12f).lightLevel(s -> 2).requiresCorrectToolForDrops().forceSolidOn());
	}

	public CrystalFenceBlock(Properties properties) {
		super(properties);
	}
