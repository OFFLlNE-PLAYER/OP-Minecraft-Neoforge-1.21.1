...
public class CrystalTrapdoorBlock extends TrapDoorBlock {
	public CrystalTrapdoorBlock() {
		super(BlockSetType.STONE, Properties.of().sound(SoundType.AMETHYST).strength(5.5f, 12f).lightLevel(s -> 2).requiresCorrectToolForDrops());
	}

	public CrystalTrapdoorBlock(Properties properties) {
