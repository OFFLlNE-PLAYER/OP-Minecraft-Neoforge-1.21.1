...
public class CrystalBricksBlock extends Block {
	public static final EnumProperty<Direction.Axis> AXIS = BlockStateProperties.AXIS;

	public CrystalBricksBlock() {
		super(Properties.of().mapColor(MapColor.ICE).sound(SoundType.AMETHYST).strength(5.5f, 12f).lightLevel(s -> 2).requiresCorrectToolForDrops());
