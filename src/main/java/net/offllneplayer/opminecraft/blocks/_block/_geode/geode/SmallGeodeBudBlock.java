...
public class SmallGeodeBudBlock extends Block implements SimpleWaterloggedBlock {
    public static final DirectionProperty FACING = DirectionalBlock.FACING;
    public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

    private final GeodeMaterial material;

    public SmallGeodeBudBlock(GeodeMaterial material) {
        super(Properties.of()
    ...
    public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
        return switch (state.getValue(FACING)) {
            default -> box(3, 0, 3, 13, 5, 13);
            case NORTH -> box(3, 3, 11, 13, 13, 16);
            case SOUTH -> box(3, 3, 0, 13, 13, 5);
    ...
    public boolean canSurvive(BlockState state, LevelReader world, BlockPos pos) {
        // Vanilla-parity: check the block behind (opposite of FACING) and the face toward the bud (FACING)
