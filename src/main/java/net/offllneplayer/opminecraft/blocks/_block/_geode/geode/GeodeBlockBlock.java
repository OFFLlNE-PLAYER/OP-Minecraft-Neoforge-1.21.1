...
/**
 * Generalized solid geode block (e.g., Crystal Block). Stores material for future extensibility.
 */
public class GeodeBlockBlock extends Block {
    public static final EnumProperty<Direction.Axis> AXIS = BlockStateProperties.AXIS;
    private final GeodeMaterial material;

    public GeodeBlockBlock(GeodeMaterial material) {
        super(Properties.of()
    ...
    public void randomTick(BlockState state, ServerLevel world, BlockPos pos, RandomSource random) {
        ...
        // Solid geode blocks do not grow buds; budding blocks handle growth. Leaving here no-op.
        // If in future some materials allow growth from the solid block, we could call BuddingGeodeBlock_Method.
    }
