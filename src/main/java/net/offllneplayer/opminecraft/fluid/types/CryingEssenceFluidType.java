...
package net.offllneplayer.opminecraft.fluid.types;
...
public class CryingEssenceFluidType extends FluidType {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("opminecraft:block/text_crying_essence");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("opminecraft:block/text_crying_essence_flowing_anime");
