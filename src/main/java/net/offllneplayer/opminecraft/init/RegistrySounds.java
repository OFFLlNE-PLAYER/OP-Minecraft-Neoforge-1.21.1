...
/*-----------------------------------------------------------------------------------------------------------------------*/
        ...
        public static final DeferredHolder<SoundEvent, SoundEvent> PROTEKTOR_BERETTA_R = SOUNDSREGISTRY.register("protektor_beretta_r", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("opminecraft", "protektor_beretta_r")));
        public static final DeferredHolder<SoundEvent, SoundEvent> PROTEKTOR_BERETTA_0 = SOUNDSREGISTRY.register("protektor_beretta_0", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("opminecraft", "protektor_beretta_0")));
        public static final DeferredHolder<SoundEvent, SoundEvent> PROTEKTOR_BERETTA_1 = SOUNDSREGISTRY.register("protektor_beretta_1", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("opminecraft", "protektor_beretta_1")));
