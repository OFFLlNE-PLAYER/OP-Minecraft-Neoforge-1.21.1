...
public class RegistryDamageTypes {
    ...
    public static final ResourceKey<DamageType> HANDCANNON = ResourceKey.create(Registries.DAMAGE_TYPE,
       ResourceLocation.fromNamespaceAndPath(OPMinecraft.Mod_ID, "handcannon"));
    ...
    public static final ResourceKey<DamageType> MAGNUM = ResourceKey.create(Registries.DAMAGE_TYPE,
          ResourceLocation.fromNamespaceAndPath(OPMinecraft.Mod_ID, "magnum"));
