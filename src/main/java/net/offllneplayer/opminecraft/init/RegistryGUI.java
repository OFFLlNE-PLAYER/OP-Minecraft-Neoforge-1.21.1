...
import net.offllneplayer.opminecraft.blocks._block._furnace.OPFurnaceGUI;
import net.offllneplayer.opminecraft.blocks._block._ancientchest.AncientChestGUI;
