...
public class CryingEssenceFlowingCondition_Method {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		...
		if (!(world.getBlockState(BlockPos.containing(x, y - 1, z))).is(DeclareTagKeys.Blocks.LAVAS)
				|| !(world.getBlockState(BlockPos.containing(x, y - 1, z))).is(DeclareTagKeys.Blocks.WATERS))  {
			flow_logic = true;
		}
		return flow_logic;
	}
