...
public record IronFurnaceSlotHandler(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final Type<IronFurnaceSlotHandler> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OPMinecraft.Mod_ID, "gui_iron_furnace_slots"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OPMinecraft.addNetworkMessage(IronFurnaceSlotHandler.TYPE, IronFurnaceSlotHandler.STREAM_CODEC, IronFurnaceSlotHandler::handleData);
	}
}
