...
package net.offllneplayer.opminecraft.method._handler.GUI_Slot;
...
public record NetheriteFurnaceSlotHandler(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final Type<NetheriteFurnaceSlotHandler> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OPMinecraft.Mod_ID, "gui_netherite_furnace_slots"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OPMinecraft.addNetworkMessage(NetheriteFurnaceSlotHandler.TYPE, NetheriteFurnaceSlotHandler.STREAM_CODEC, NetheriteFurnaceSlotHandler::handleData);
	}
}
