...
import net.offllneplayer.opminecraft.items._item.crying.armor.FullCrying_Method;
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(Type.class), map -> {
				...
				map.put(Type.BODY, 7);
			}), 20, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("items.armor.equip_netherite")),
