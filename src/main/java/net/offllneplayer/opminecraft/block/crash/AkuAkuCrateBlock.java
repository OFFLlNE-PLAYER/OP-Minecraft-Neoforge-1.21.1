...
public class AkuAkuCrateBlock extends Block {
	...
	public boolean canHarvestBlock(BlockState state, BlockGetter world, BlockPos pos, Player player) {
		return super.canHarvestBlock(state, world, pos, player) && PROCAkuAkuCheckSilkTouchProcedure.execute(player.level(), pos.getX(), pos.getY(), pos.getZ(), player);
	}

	@Override
	public void entityInside(BlockState blockstate, Level world, BlockPos pos, Entity entity) {
		super.entityInside(blockstate, world, pos, entity);
		PROCAkuAkuCrateCollisionProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
	}
}
