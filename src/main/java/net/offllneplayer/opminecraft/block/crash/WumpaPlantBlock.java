...
import net.offllneplayer.opminecraft.method.crash.wumpaplant.PROCWumpaPlantOnClickProcedure;
...
public class WumpaPlantBlock extends Block {
	...
	public boolean onDestroyedByPlayer(BlockState blockstate, Level world, BlockPos pos, Player entity, boolean willHarvest, FluidState fluid) {
		...
		PROCWumpaPlantOnClickProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
		return retval;
	}

	@Override
	public void onProjectileHit(Level world, BlockState blockstate, BlockHitResult hit, Projectile entity) {
		PROCWumpaPlantOnClickProcedure.execute(world, hit.getBlockPos().getX(), hit.getBlockPos().getY(), hit.getBlockPos().getZ(), entity);
	}
	...
	public InteractionResult useWithoutItem(BlockState blockstate, Level world, BlockPos pos, Player entity, BlockHitResult hit) {
		...
		PROCWumpaPlantOnClickProcedure.execute(world, x, y, z, entity);
