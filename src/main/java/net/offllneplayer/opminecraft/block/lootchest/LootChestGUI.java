...
public class LootChestGUI extends AbstractContainerScreen<LootChestInv> {
	private final static HashMap<String, Object> guistate = LootChestGUI.guistate;
	private Level world;
	private int x, y, z;
	...
	public LootChestGUI(LootChestInv container, Inventory inventory, Component text) {
		...
		// Set textures
		this.bgTexture = ResourceLocation.parse("opminecraft:textures/screens/ancient_chest/wood/gui_" + woodName + "_loot_chest.png");
		this.trimTexture = ResourceLocation.parse("opminecraft:textures/screens/ancient_chest/trim/gui_" + trimName + "_loot_chest.png");
